...
Compilation options: -lang wasm -cn OneChnMix -es 1 -mcd 16 -single -ftz 2 
*/

function getJSONOneChnMix() {
	return '{"name": "OneChnMix","filename": "OneChnMix.dsp","version": "2.40.12","compile_options": "-lang wasm -cn OneChnMix -es 1 -mcd 16 -single -ftz 2","include_pathnames": ["/usr/local/share/faust","/usr/local/share/faust","/usr/share/faust",".","/tmp/sessions/95312EE7422085872A13E1EBE11ABB85A2E5F169/web/wasmjs"],"size": 32,"inputs": 1,"outputs": 2,"meta": [ { "basics_lib_name": "Faust Basic Element Library" },{ "basics_lib_version": "0.8" },{ "compile_options": "-single -scal -I libraries/ -I project/ -lang wasm" },{ "filename": "OneChnMix.dsp" },{ "library_path0": "/libraries/stdfaust.lib" },{ "library_path1": "/libraries/basics.lib" },{ "library_path2": "/libraries/signals.lib" },{ "library_path3": "/libraries/maths.lib" },{ "library_path4": "/libraries/platform.lib" },{ "maths_lib_author": "GRAME" },{ "maths_lib_copyright": "GRAME" },{ "maths_lib_license": "LGPL with exception" },{ "maths_lib_name": "Faust Math Library" },{ "maths_lib_version": "2.5" },{ "name": "OneChnMix" },{ "platform_lib_name": "Generic Platform Library" },{ "platform_lib_version": "0.2" },{ "signals_lib_name": "Faust Signal Routing Library" },{ "signals_lib_version": "0.3" },{ "version": "2.41.1" }],"ui": [ {"type": "hgroup","label": "OneChnMix","items": [ {"type": "vslider","label": "Gain","shortname": "Gain","address": "/OneChnMix/Gain","index": 16,"meta": [{ "style": "knob" }],"init": 0,"min": -40,"max": 10,"step": 0.1},{"type": "nentry","label": "Pan","shortname": "Pan","address": "/OneChnMix/Pan","index": 4,"meta": [{ "style": "knob" }],"init": 0.5,"min": 0,"max": 1,"step": 0.01},{"type": "checkbox","label": "mute","shortname": "mute","address": "/OneChnMix/mute","index": 0}]}]}';
}
/*
 faust2webaudio
...
// Usage : OneChnMix.createDSP(audioCtx, 1024).then(dsp => dsp.connect(audioCtx.destination));
